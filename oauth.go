...
func NewClient(scope string) *http.Client {
...
func getOAuthClient(g_config *oauth.Config) *oauth.Transport {
	cacheFile := os.Getenv("GS_TOKEN_FILE")
...
func serveCallback(listener *net.TCPListener, randState string, ch chan string) {
